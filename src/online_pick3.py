...
if __name__=='__main__':
    ...
    print("joint_open:", gripper.set_joint_value_target(gripper_joint_values))
 ...
 #new_eef_pose.position.z = current_pose.pose.position.z - 0.05     #0.20
  ...
  ## disabling it.
    ...
    # angle = radians(60) # angles are expressed in radians
    ...
    gripper_joint_values_close = gripper.get_current_joint_values()
    gripper_joint_values_close[0] = -0.007
    gripper_joint_values_close[1] = 0
    #print("close_values:",gripper_joint_values_close)
    gripper.set_joint_value_target(gripper_joint_values_close)
    #print ("jointvalues:",gripper.set_joint_value_target(gripper_joint_values_close))
    plan = gripper.plan()
    print("plan executed")
    rospy.sleep(1)
    gripper.go(wait=True)
